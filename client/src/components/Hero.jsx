...
const Hero = () => {
    ...
    const onSearch = async (e)=>{
     ...
     destination}, {header: {Authorization: `Bearer ${await getToken()}`}})
  ...
  return (
    ...
    md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.jpg")]
    bg-no-repeat bg-cover bg-center h-screen'>
    <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>
        The Ultimate Hotel Experience</p>
    <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-
