...
useEffect(()=>{
 ...
 room && setMainImage(room.images[0])
  ...
  return room &&(
<div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 x;:px-32'>
      {/*Room Details*/}
...
<div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
 ...
 <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
  <p>Guests will be allocated the floors according to the availability.
    You get a comfortable Two bedroom apartment has a true city feeling. The price 
    quoted is for two guests, at guest slot please mark the number of guests to get the 
    exact price for the rooms.
  </p>
 </div>
...
<div className='flex gap-4'>
  ...
  className='h-14 w-14 md:h-10 md:w-10 rounded-full'/>
  <div>
